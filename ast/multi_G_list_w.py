...
for n in range(list_size):
	...
	while(1):
		...
		chi2 = np.sum((fGs(cut_xlist,params[0],params[1],params[2],params[3],params[4],params[5]) - ylist_norm[pos[0]:(pos[5]+1)])**2)/np.size(cut_xlist)
		...
		plt.ylabel('Normalized flux')
		plt.yticks([])
		plt.plot(xlist[(pos[0]-100):(pos[5]+100+1)], ylist_norm[(pos[0]-100):(pos[5]+100+1)], color="gray", label="data")
