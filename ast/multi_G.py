...
while(1):
	...
	while(1):
		...
		chi2 = np.sum((fGs(cut_xlist,params[0],params[1],params[2],params[3],params[4],params[5]) - ylist[pos[0]:(pos[5]+1)])**2)/np.size(cut_xlist)
		print('chi2: %f' %chi2)
		...
		plt.yticks([])
		plt.plot(xlist[(pos[0]-100):(pos[5]+100+1)], ylist[(pos[0]-100):(pos[5]+100+1)], color="black", label="data")
