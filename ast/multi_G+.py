...
for n in range(list_size):
	...
	while(1):
		...
		plt.yticks([])
		plt.plot(xlist[(pos[0]-100):(pos[5]+100+1)], ylist[(pos[0]-100):(pos[5]+100+1)], color="gray", label="data")
		plt.plot(xlist[(pos[0]-100):(pos[5]+100+1)], ylist_t[(pos[0]-100):(pos[5]+100+1)],color='black',label='smoothed data')
