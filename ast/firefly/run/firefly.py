...
input_file=input('input the name of the target: ')
data = np.loadtxt(input_file, unpack=True)
suffix = ""

#redshift
redshift = float(input('input the redshift: '))
...
# RA and DEC
ra=float(input('input ra: ')) ; dec=float(input('input dec: '))

#velocity dispersion in km/s
vdisp = float(input('input vdisp: '))
